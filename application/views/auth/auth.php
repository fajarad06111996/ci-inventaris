      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <br>
            <form method="POST" action="<?php echo base_url("C_auth/cek_login") ?>" class="needs-validation" novalidate="">
            ...
            <div class="text-center mt-5 text-small">
              <b>Template By Stisla</b>
            </div>
          </div>
        </div>
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?php echo base_url() ?>assets/img/Koala.jpg">
